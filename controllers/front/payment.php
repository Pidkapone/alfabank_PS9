...
class PaykeeperPaymentModuleFrontController extends ModuleFrontController
{
    ...
    private $fiscalCart = [];
    /** @var bool */
    private $useTaxes = false;
    /** @var bool */
    private $useDelivery = false;
    /** @var int */
    private $deliveryIndex = -1;
    /** @var int */
    private $singleItemIndex = -1;
    /** @var int */
    private $moreThanOneItemIndex = -1;
    /**
    ...
    public function initContent(): void
    {
        ...
        if ($secret === '') {
            $secret = Paykeeper::getDefaultSecretWord();
        }

        if ($formUrl === '') {
            $formUrl = Paykeeper::getDefaultFormUrl();
        }
